...
public class MainActivity extends AppCompatActivity {
    ...
    private Fruit[] fruits = {new Fruit("Apple", R.drawable.aaple_pic), new Fruit("Banana", R.drawable.banana_pic),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setHomeAsUpIndicator(R.drawable.mmm);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                break;
            case R.id.cloud:
                Toast.makeText(this, "You clicked Cloud", Toast.LENGTH_SHORT).show();
                break;
            case R.id.delete:
